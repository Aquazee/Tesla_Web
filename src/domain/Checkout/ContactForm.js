...
const ContactForm = () => {
  ...
  return (
    <form name="contact" className="accordion-item needs-validation" noValidate="" >
      <div className='card mb-1' id="contactCheckout">
        <div className="card-header card-body p-1">
          ...
          <div className="collapse show card-body mb-2" id="contactForm" aria-labelledby="contactCheckout" data-parent="#checkout">
            <div className="row">
              <InputBox
